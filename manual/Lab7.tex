...
\begin{figure}[H]
	\begin{center}
		\caption{Expected Results of the ALU test.}\label{fig:ert_registertest}
...
\begin{figure}[H]
	\begin{center}
		\caption{Timing diagram for the ALU control test.}\label{fig:registertest}
		\includegraphics[width=1.0\textwidth]{../images/ALUControlSimulation.png}
	\end{center}
\end{figure}
...
\Verilog{Verilog code of ALU.}{code:regtest}{../code/3_execute/alu.v}
\Verilog{Verilog code of ALU control.}{code:reg}{../code/1_fetch/register.v}
\end{document} 